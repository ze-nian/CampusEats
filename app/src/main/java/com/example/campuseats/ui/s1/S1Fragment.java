package com.example.campuseats.ui.s1;
...
public class S1Fragment extends Fragment {
    ...
    private S1ViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View S1View = inflater.inflate(R.layout.fragment_s1, container, false);
        RootView = S1View;
        ...
        final List<String> namesList = Arrays.asList( "起司披薩", "羅勒、番茄披薩", "牛肉、蘑菇、青花菜披薩","培根、蘑菇、洋蔥披薩","雞肉、墨西哥辣椒、番茄披薩");
        final List<Integer> priceList = Arrays.asList(160,170,200,200,200);
        ...
        //數量紀錄(不會跳出變0)
        for (int j=2;j<7;j++){
            final int quantity_id=getResources().getIdentifier("s1_"+j, "id", getActivity().getPackageName());
            TextView tt = S1View.findViewById(quantity_id);
            try {
        ...
        //add
        for (int i = 2; i < 7; i++) {
            final int id = getResources().getIdentifier("s1_"+i+"_add", "id", getActivity().getPackageName());
            Button btnAdd = S1View.findViewById(id);
            final int finalI = i;
            ...
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    final int tid = getResources().getIdentifier("s1_"+finalI, "id", getActivity().getPackageName());
        ...
        //minus
        for (int i = 2; i < 7; i++) {
            final int id = getResources().getIdentifier("s1_"+i+"_minus", "id", getActivity().getPackageName());
            Button btnAdd = S1View.findViewById(id);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(S1ViewModel.class);
